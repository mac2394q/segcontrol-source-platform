...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        ...
        <?php if(is_null($sesion_nombre) == true || strcmp($sesion_nombre, "") !== 0){
         ...
         <div class="name" data-toggle="dropdown">ASISTENTE</div>';
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li> <a href="" id="workspaceAsis" ><i class="zmdi zmdi-apps"></i><span>Principal</span> </a>
            </li>
            <!-- <li> <a href="" id="perfil" ><i class="zmdi zmdi-accounts-alt"></i><span>Cuenta</span> </a>
            </li> -->
