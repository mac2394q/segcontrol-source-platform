        ...
        <div class='row clearfix'>
          <div class='col-sm-8'>
            <div class='form-group'>
              <div class='form-line'>
                <input type='text' class='form-control font-bold' name='RazonSocial' id='RazonSocial' placeholder='Buscar por razon social . . .' >
              </div>
            </div>
          </div>
          <div class='col-sm-4'>
            <div class='form-group'>
              <button type='button' id='buscarClienteRazon' class='btn btn-raised bg-blue btn-sm waves-effect'> <i class='zmdi zmdi-search-replace zmdi-hc-4x'></i> </button>
            </div>
          </div>
        <div id='tablacliente'>
        ...
        if(is_null( $arrayObj1) == true || empty($arrayObj1) ==true ){
          ...
          <div class='row clearfix'>
           <div class='col-sm-8'>
            <div class='form-group'>
              <div class='form-line'>
                <input type='text' class='form-control font-bold' name='Placa' id='Placa' placeholder='Buscar por placa . . .' >
              </div>
            </div>
          </div>
          <div class='col-sm-4'>
            <div class='form-group'>
              <button type='button' id='buscarVehiculoPlaca' class='btn btn-raised bg-blue btn-sm waves-effect'> <i class='zmdi zmdi-search-replace zmdi-hc-4x'></i> </button>
            </div>
          </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="card">
          ...
          if(is_null( $arrayObj2) == true || empty($arrayObj2) ==true ){
            ...
            echo "
            <div class='header'>
            <h2> Conductores <small>Listado de conductores activos registrados en el sistema <small></h2>
            </div>
            <div class='body'>
            <div class='row clearfix'>
            <div class='col-sm-8'>
            <div class='form-group'>
              <div class='form-line'>
                <input type='text' class='form-control font-bold' name='Nombre' id='Nombre' placeholder='Buscar por Nombre . . .' >
              </div>
            </div>
          </div>
          <div class='col-sm-4'>
            <div class='form-group'>
              <button type='button' id='buscarConductorNombre' class='btn btn-raised bg-blue btn-sm waves-effect'> <i class='zmdi zmdi-search-replace zmdi-hc-4x'></i> </button>
            </div>
          </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="form-line">
                      ...
                      <input type="text" class="form-control" name="municipio" id="municipio" placeholder="Ciudad Origen" required>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="form-line">
                      ...
                      <input type="text" class="form-control" name="municipio2" id="municipio2" placeholder="Ciudad Destino" required>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            ...
            <div class="body">
              <div class="form-group col-xs-6">
                ...
                </div><!--<h2 class="card-inside-title">A tener en cuenta :</h2>
                <div class="demo-checkbox">
                  <input type="checkbox" id="basic_checkbox_2" class="filled-in" checked />
                  <label for="basic_checkbox_2">Desea enviar correo de notificacion del inicio de servicio </label>
                </div> -->
                <br/>
